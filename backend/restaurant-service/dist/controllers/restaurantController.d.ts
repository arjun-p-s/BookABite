...
export declare const editRestaurant: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const deleteRestaurant: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const listRestaurants: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
